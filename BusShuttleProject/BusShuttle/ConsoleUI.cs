...
public class ConsoleUI{
    ...
    public void Show(){
        ...
        if (mode=="driver"){
            ...
            do{
                command = AnsiConsole.Prompt(new SelectionPrompt<string>().Title("What do you want to do?").AddChoices(new[]{"show busiest stop","add stop","delete stop","list stops","end"}));
